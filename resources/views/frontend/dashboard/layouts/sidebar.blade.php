...
<div class="dashboard_sidebar">
  ...
  <ul class="dashboard_link">
    <li><a class="{{setActive(['user.dashboard'])}}" href=""><i class="fas fa-tachometer"></i>Dashboard</a></li>

    <li><a class="{{setActive(['user.messages.index'])}}" href=""><i class="fas fa-tachometer"></i>Messages</a></li>

    <li><a class="" href="{{url('/')}}"><i class="fas fa-home"></i>Go To Home Page</a></li>

    @if (auth()->user()->role === 'vendor')
    <li><a class="{{setActive(['vendor.dashbaord'])}}" href=""><i class="fas fa-tachometer"></i>Go to Vendor Dashboard</a></li>
    @endif
    ...
    @if (auth()->user()->role !== 'vendor')
    <li><a class="{{setActive(['user.vendor-request.*'])}}" href=""><i class="far fa-user"></i> Request to be vendor</a></li>
    @endif
    <li>
