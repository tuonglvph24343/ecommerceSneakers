            ...
            <div class="col-xl-5 col-3 col-md-3 col-lg-6">
                <div class="wsus__call_icon_area">
                    ...
                    <ul class="wsus__icon_area">
                        ...
                        <li> <a class="wsus__cart_icons" href="{{ route('user.notifications.index') }}">
                                <i class="fa fa-bell"></i>
                                <span class="badge_count">{{ \App\Http\Controllers\Frontend\NotificationController::getClientUnreadNotificationsCount() }}</span>
                            </a></li>
                    </ul>
                </div>
            </div>
            ...
            @foreach (Cart::content() as $sidebarProduct)
                <li id="mini_cart_{{ $sidebarProduct->rowId }}">
                    ...
                    <div class="wsus__cart_text">
                        ...
                        <small>
                            Tổng cộng:{{ number_format($sidebarProduct->options->variants_total, 0, ',', '.') }}
        ...
        <div class="mini_cart_actions {{ Cart::content()->count() === 0 ? 'd-none' : '' }}">
            <h5>
                ...
                <span id="mini_cart_subtotal">
                    {{ number_format(getCartTotal(), 0, ',', '.') }} {{ $settings->currency_icon }}
                </span>
            </h5>
