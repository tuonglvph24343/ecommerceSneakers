            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus__menu_item">
                        ...
                        @foreach ($categories as $category)
                        <li class="wsus__relative_li"><a class="{{count($category->subCategories) > 0 ? 'wsus__droap_arrow' : ''}}" href="{{route('products.index', ['category' => $category->slug])}}"><i
                                    class="fas fa-caret-down"></i> {{$category->name}}</a>
                                    @if(count($category->subCategories) > 0)
